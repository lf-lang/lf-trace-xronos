...
function(add_grpc)
  ...
  FetchContent_Declare(
    ...
    GIT_SUBMODULES
      ...
      "third_party/re2"
    # Avoid protoc being invoked with an empty-string argument ("") during gRPC's reflection
    # proto generation (seen with some Protobuf include-dir configurations).
    PATCH_COMMAND
      ${CMAKE_COMMAND} -E chdir <SOURCE_DIR>
      /bin/sh -c
      "PATCH_FILE='${CMAKE_CURRENT_LIST_DIR}/patches/fix-empty-protoc-arg.patch'; \
       git apply --check \"$PATCH_FILE\" 2>/dev/null && git apply --whitespace=nowarn \"$PATCH_FILE\" || \
       git apply -R --check \"$PATCH_FILE\" 2>/dev/null"
